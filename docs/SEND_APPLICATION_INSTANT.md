...
| `skipped_other` | "Lead saved. The application email was skipped. Check the lead's drip log." | Catch-all: the row's `last_error` carried a `skipped:` prefix that isn't one of the recognized causes above. Check `drip_runs.last_error` directly. |
