...
export const SUN_NAV: NavItem[] = [
  ...
  // Live Subs — the stage where the Breeze UW Entry Sheet scrubber injects
  // Ezra-approved deals (approval happens via Telegram; this page mirrors it).
  { group: "Pipeline", href: "/uw-sheet", label: "Live Subs", icon: "ClipboardCheck" },
