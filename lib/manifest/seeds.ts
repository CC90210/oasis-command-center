...
export const SUN_SEED: TenantManifest = {
  ...
  agents: [
    ...
    // Where Matt goes when they need work done. CORE: locked, cannot
  ...
  nav: [
    ...
    // Top-level /agent chat — Matt picks between Solara (operational) and
  ...
  data_model: [
    {
      ...
      fields: [
        ...
        // 2026-06-30 (CC): added `uw_sheet` (label "Live Subs") directly after
        // intent_inquiry_submitted — Ezra-approved Breeze UW-Sheet deals. Matches
