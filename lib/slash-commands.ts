...
const BRAVO: SlashCommand[] = [
  ...
  { slug: "prime", agent: "bravo", category: "exec", description: "Load full Bravo context for a deep session",
    cli_invocation: "claude /prime", cwd_hint: BRAVO_REPO },
  { slug: "status", agent: "bravo", category: "ops", description: "Current state snapshot — what's running, what's pending, what's stale",
    cli_invocation: "claude /status", cwd_hint: BRAVO_REPO },
  { slug: "research", agent: "bravo", category: "intel", description: "Multi-source research on a topic — web + repo + memory",
    cli_invocation: "claude /research", cwd_hint: BRAVO_REPO },
  { slug: "review", agent: "bravo", category: "dev", description: "Pull request / branch review — structural + adversarial pass",
    cli_invocation: "claude /review", cwd_hint: BRAVO_REPO },
  { slug: "qbr", agent: "bravo", category: "exec", description: "Quarterly business review — KPIs, OKRs, retros, plan",
    cli_invocation: "claude /qbr", cwd_hint: BRAVO_REPO },
  { slug: "strategic-review", agent: "bravo", category: "exec", description: "Strategic planning review — direction, risks, calendar",
    cli_invocation: "claude /strategic-review", cwd_hint: BRAVO_REPO },
  { slug: "ingest", agent: "bravo", category: "ops", description: "Ingest a doc/transcript/file into the knowledge wiki",
    cli_invocation: "claude /ingest", cwd_hint: BRAVO_REPO },
  { slug: "query-knowledge", agent: "bravo", category: "ops", description: "Query the knowledge wiki for facts the agents have learned",
    cli_invocation: "claude /query-knowledge", cwd_hint: BRAVO_REPO },
  { slug: "knowledge-maintenance", agent: "bravo", category: "ops", description: "Lint + repair the knowledge wiki — stale links, drift",
    cli_invocation: "claude /knowledge-maintenance", cwd_hint: BRAVO_REPO },
  { slug: "post", agent: "bravo", category: "content", description: "Schedule a post across all enabled social platforms via Late",
    cli_invocation: "claude /post", cwd_hint: BRAVO_REPO },
  { slug: "skool-edit", agent: "bravo", category: "content", description: "Edit a Skool community post in place",
    cli_invocation: "claude /skool-edit", cwd_hint: BRAVO_REPO },
  { slug: "skool-push", agent: "bravo", category: "content", description: "Publish a new post / comment to the Skool community",
    cli_invocation: "claude /skool-push", cwd_hint: BRAVO_REPO },
  { slug: "n8n", agent: "bravo", category: "ops", description: "n8n workflow ops — list, get, activate, edit",
    cli_invocation: "python scripts/n8n_tool.py", cwd_hint: BRAVO_REPO },
  { slug: "browser-harness", agent: "bravo", category: "ops", description: "Browser automation harness — attach to logged-in Chrome",
    cli_invocation: "python scripts/browser_harness_doctor.py", cwd_hint: BRAVO_REPO },
  { slug: "cli-anything", agent: "bravo", category: "dev", description: "Generate an agent-native CLI wrapper for any tool/API",
    cli_invocation: "claude /cli-anything", cwd_hint: BRAVO_REPO },
  { slug: "opencli", agent: "bravo", category: "dev", description: "OpenCLI registry — discover/run unified-CLI commands",
    cli_invocation: "opencli", cwd_hint: BRAVO_REPO },
  { slug: "onboard-team-member", agent: "bravo", category: "ops", description: "Onboard a new teammate — access, repos, env",
    cli_invocation: "claude /onboard-team-member", cwd_hint: BRAVO_REPO },
  { slug: "sync", agent: "bravo", category: "ops", description: "State sync — flush memory, update STATE.md, push pulse to peers",
    cli_invocation: "python scripts/state_sync.py", cwd_hint: BRAVO_REPO },
];
