...
- **Interactive visual:** `brain/playbooks/oasis-loop-method/index.html`
- **This playbook:** `brain/playbooks/oasis-loop-method/README.md`
- **Agent Command Centre system messages:** Available on the OASIS AI portal
- **Referenced in:** AGENTS.md, CLAUDE.md, GEMINI.md, ANTIGRAVITY.md, OPENCODE.md
