  ...
  return <div className="space-y-6 animate-fade-in">
    ...
    <Card title="The pipeline — who does what" subtitle="Every stage has one owner, one required action, and one completion rule.">
      <div className="space-y-3">
        ...
        <PipelineStep stage="Connected" owner="Agent" action="Diagnose the visible website problem, its business consequence, authority, timing, and minimum $500 setup plus $150/month willingness." done="All four qualification gates are confirmed or the lead is marked Lost." />
    ...
    <Card title="Rep compensation" subtitle="Percent of collected setup revenue · paid on cash collected · no recurring share in V1.">
      <p className="text-sm leading-relaxed text-fg-muted mb-4">The standard ladder is simple: <b className="text-fg">open 15%</b>, <b className="text-fg">close 25%</b>, or <b className="text-fg">find and close 35%</b>. These are the same numbers as in your agreement and the same numbers the payout runs on — every surface reads from one engine.</p>
      <div className="grid sm:grid-cols-2 gap-3">
        ...
        <RateCard role="You close it" rate={pct(COMPANY_TRACK_BPS.closer / 10000)} detail="Close a company-sourced lead. If a separate opener is credited, their 15% is recorded independently; your closer rate stays 25%."/>
