  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {group === "clients" && (!brand || brand === "arthrisil") && (
        <Card title="Arthrisil · Social-proof edit V5" subtitle="Client creative · Internal review · 48s · 9:16">
          <div className="grid gap-5 lg:grid-cols-[minmax(260px,420px)_1fr]">
            <div className="overflow-hidden rounded-2xl border border-bg-border bg-black">
              ...
              >
                <source src="/media/arthrisil-marketing/arthrisil-social-proof-v5.mp4" type="video/mp4" />
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-fg-muted">
                  Three complete outside perspectives establish pain and lost mobility. A silent introduction gives Dr. Michael
                  Azoulay room to enter before a transcript-led sequence moves from quality-of-life impact to a natural solution,
                  the Arthrisil reveal, and an animated product close.
                </p>
              </div>
