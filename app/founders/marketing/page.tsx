...
export default async function MarketingPage() {
  ...
  const needsYou = summary.open_reviews + summary.open_requests;
      ...
      <PageHeader
        ...
        subtitle={
          summary.total === 0
            ...
            : `Founders portal · ${summary.total} ${summary.total === 1 ? "asset" : "assets"} across every channel`
        }
      />
          ...
          <Card noPadding>
            <div className="divide-y divide-bg-border">
              <div className="px-5 py-4 text-sm text-fg-muted">
                {needsYou} item{needsYou === 1 ? "" : "s"} pending. The review queue UI lands in
                Phase 3.
              </div>
            </div>
          </Card>
